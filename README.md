...
- **日常国内直连**：优先 <https://residency-countdown.rth1.xyz/>。  
- **境外、挂 VPN，或上表 2 打不开**：可改用 <https://residency-countdown.vercel.app/>。若书签里仍是旧域（如 `tomato193.rth1.xyz`），以当前 **residency-countdown.rth1.xyz** 为准。  

内网 **IP/端口** 若调整，以维护者通知为准；Vercel 的用量以 [Vercel](https://vercel.com) 为准；国内热铁盒与 DNS 以实际解析为准。
